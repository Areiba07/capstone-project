        ...
        <div className="container justify-center text-center flex  mx-auto ">
          <div className="justify-between  md:w-2/5 bg-violet-500 bg-opacity-70 p-6 rounded-lg mb-4">
            ...
            <p className="text-lg text-gray-700">
              ...
              you're a freelancer, contractor, or business owner, HanapBuhay has
              got you covered. Take advantage of our advanced search filters,
              showcase your portfolio, and connect with service seekers looking
              for your expertise.
            </p>
            <br />
            <br />
          ...
          <div className="md:w-2/5 bg-blue-400 bg-opacity-80 p-6 rounded-lg mb-4">
            ...
            <p className="text-lg text-gray-700">
              Finding the right service provider for your needs is crucial, and
              we're here to make the process efficient and effective. HanapBuhay
              provides a powerful platform that enables you to search and
              connect with qualified service providers. Post your service
              requirements, browse through profiles, and engage with service
              providers who meet your criteria. Our platform also offers
              seamless communication channels, allowing you to discuss project
              details, negotiate terms, and manage the hiring process with ease.
            </p>
            <br />
            <div>
              <Button gradientDuoTone="purpleToPink" pill>
